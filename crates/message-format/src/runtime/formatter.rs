...
///
/// ```rust,no_run
/// use message_format::runtime::{Catalog, FormatError, Formatter, HostFn, HostCallError, Value};
///
...
/// impl message_format::runtime::FormatSink for StringSink<'_> {
...
///     fn markup_close(&mut self, _name: &str, _options: &[message_format::runtime::FormatOption<'_>]) {}
/// }
...
impl<C: AsRef<Catalog>, H: Host> MultiFormatter<C, H> {
    ...
    /// # Args safety
    ///
    /// `args` must carry [`StrId`](crate::runtime::StrId) keys from the same catalog
