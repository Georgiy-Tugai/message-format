...
/// Used with [`Formatter::format_to`](crate::runtime::Formatter::format_to).
///
...
/// [`FormatOption`] values.
///
/// Markup does not contribute text on its own. The crate-level convenience
...
mod tests {
    ...
    use crate::runtime::error::{ImplementationFailure, MessageFunctionError};
